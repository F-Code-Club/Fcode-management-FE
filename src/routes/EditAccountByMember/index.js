...
const EditAccountByMember = () => {
    ...
    const UpdateInfo = async () => {
        ...
        if (info.personalEmail !== APIPersonalEmail) {
            ...
            setIsModalOpen(true);
            const response = await productApi.updateOwnAccountPersonalEmail(info, token);
            ...
            >
                <Message>
                    ...
                    <MessageHero>
                        ...
                        <p>
                            Hãy kiểm tra mail và tiến hành xác thử để hoàn thành việc thay đổi mail
                            liên kết
                        </p>
                    </MessageHero>
                </Message>
...
export default EditAccountByMember;
